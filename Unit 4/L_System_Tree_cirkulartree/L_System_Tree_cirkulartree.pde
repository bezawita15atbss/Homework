...
void setup() {
  ...
  rules.set("D", "42D!/84D!/42D");
  rules.set("F", "D![+A]D[+B]");
  rules.set("A", "FC1F<21@0.9F<21@0.9F<21@0.9F<21@0.9F<21");
  rules.set("A", "@0.9F<21@0.9F<21@0.9F<21@0.9F<21@0.9F<21@0.9F<21");
  rules.set("B", "FC255F>21@0.9F>21@0.9F>21@0.9F>21@0.9F>21");
  rules.set("B", "@0.9F>21@0.9F>21@0.9F>21@0.9F>21@0.9F>21@0.9F>21");
...
void rewriteWord() {
  ...
  for (currentCharacter= 0; currentCharacter < existingWord.length(); currentCharacter++) {
    ...
    else if ( existingWord.charAt(currentCharacter) == 'D') {
      // replace
      newWord += rules.get("D");
    } 
    else if ( existingWord.charAt(currentCharacter) == 'A') {
      // replace
      newWord += rules.get("A");
    } 
