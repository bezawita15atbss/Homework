...
String axiom = "FC1+F+F+F+F+F+FC51+F+F+F+F+F+FC102+F+F+F+F+F+FC68+F+F+F+F+F+FC34+F+F+F+F+F";
...
//   yPosition = height/2;
  ...
  rules.set("F", "F[X]");
  rules.set("X", "FSFT;FFSSFFFTTT");
  rules.set("S", "-FC1[+X]-FC128[-X]");
  rules.set("T", "+FC196[-X]+FC64[+X]");
