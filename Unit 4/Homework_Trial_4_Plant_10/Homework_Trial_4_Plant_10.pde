...
//   yPosition = height/2;
  ...
  rules.set("f", "ff[s][t]f[s][t]");
  rules.set("s", "-<5fff[++s][-t]<5f[++s][-t]-<5f[++s][-t]");
  rules.set("s", ">5[++s][-t]f>5[++s][-t]-f>5[++s][-s]");
  rules.set("t", "+<5fff[++s][-t]<5f[++s][-t]+<5f[++s][-t]");
  rules.set("t", "f>5[++s][-t]f>5[++s][-t]+f>5[++s][-t]");
